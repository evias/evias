...
namespace test {
    ...
    class jsonObjectParsing : public unitTest
    {
        public :

            jsonObjectParsing () : unitTest() {};
...
int main (int argc, char* argv[]) {
    using evias::core::test::jsonObjectParsing;
    using namespace std;

    jsonObjectParsing* unitTester = new jsonObjectParsing();
